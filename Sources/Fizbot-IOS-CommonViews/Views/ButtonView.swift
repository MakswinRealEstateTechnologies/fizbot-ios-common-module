        ...
        Button {
            ...
            ZStack {
                ...
                if isLoading {
                    ...
                    VStack {
                        Text(redactionReasons.contains(.placeholder) ? "" : title)
...
struct ButtonView_Previews: PreviewProvider {
    static var previews: some View {
        ButtonView(title: "Done", type: .Positive) {
        }.previewLayout(.sizeThatFits)
        .previewDisplayName("Positive preview")
        .padding()
        
        ButtonView(title: "Loading", type: .Positive, isLoading: .constant(true)) {
        }.previewLayout(.sizeThatFits)
        .previewDisplayName("Loading preview")
        .padding()
        
        ButtonView(title: "Cancel", type: .Negative) {
        }.previewLayout(.sizeThatFits)
        .previewDisplayName("Negative preview")
        .padding()
    }
}
